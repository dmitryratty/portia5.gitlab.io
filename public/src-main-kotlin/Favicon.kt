...
class Favicon {
    ...
    val svgSrc = Utils.srcOtherDir.resolve("favicon.svg")
    ...
    fun main() {
        ...
        val tmpPng = Utils.srcOtherDir.resolve("favicon-temp.png")
        val icoDst = Utils.srcOtherDir.resolve("favicon.ico")
        ...
        svgToPng(svgSrc, Utils.srcOtherDir.resolve("icon-512.png"), 512)
        svgToPng(svgSrc, Utils.srcOtherDir.resolve("icon-192.png"), 192)
        svgToPng(svgSrc, Utils.srcOtherDir.resolve("apple-touch-icon.png"), 180)
        generationCompleted()
    }
}